...
def iou(mask, ann, num_classes, ignore_index):
    area_intersect, area_union, area_pred_label, area_label = intersect_and_union(mask, ann, num_classes, ignore_index=ignore_index)
